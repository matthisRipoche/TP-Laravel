                    ...
                    <form action="{{ route('locations.store') }}" method="POST" class="space-y-6">
                            ...
                            <select id="film_id" name="film_id" required
                                ...
                                @foreach ($films as $film)
                                    <option value="{{ $film->id }}"
                                        @selected(old('film_id', $selectedFilm?->id) == $film->id)>
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text"
                                          ...
                                          :value="old('name')" required autofocus placeholder="ex. Château de Pierrefonds" />
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                      ...
                                      required placeholder="Décrivez ce lieu de tournage...">{{ old('description') }}</textarea>
